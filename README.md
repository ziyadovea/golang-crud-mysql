...
Для работы с HTTP использует стандартный пакет "net/http", для работы с БД - стандартный пакет "database/sql" с драйвером ["github.com/go-sql-driver/mysql"](https://github.com/go-sql-driver/mysql).
